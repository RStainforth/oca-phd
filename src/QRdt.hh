...
class QRdt: public TObject {
 ...
 public:
  QRdt( Int_t num ){ std::cout << "QRDT Object Ready!" << std::endl; }
  ...
  TH1F *GetTimeResidual()	{return (TH1F*)(GetHisto(fTimeResidual));}
  TH1F *GetTimePeak()		{return (TH1F*)(GetHisto(fTimePeak));}
  TH1F *GetTimeWidth()		{return (TH1F*)(GetHisto(fTimeWidth));}
  TH1F *GetRchToF()		{return (TH1F*)(GetHisto(fRchToF));}
  TH1F *GetToF()		{return (TH1F*)(GetHisto(fToF));}
  TH2F *GetTimeZ()		{return (TH2F*)(GetHisto(fTimeZ));}
  TH2F *GetTimeToF()		{return (TH2F*)(GetHisto(fTimeToF));}
  TH1F *GetTimeNbins()		{return (TH1F*)(GetHisto(fTimeNbins));}
  
  TH1F *GetOccupancy()		{return (TH1F*)(GetHisto(fOccupancy));}
  TH1F *GetOccWide()		{return (TH1F*)(GetHisto(fOccWide));}
  TH2F *GetOccWindowPmt()	{return (TH2F*)(GetHisto(fOccWindowPmt));}
  TH2F *GetOccWindowPmtz()	{return (TH2F*)(GetHisto(fOccWindowPmtz));}
  TH2F *GetNormWindowPmtz()	{return (TH2F*)(GetHisto(fNormWindowPmtz));}
  TH2F *GetOccZ()		{return (TH2F*)(GetHisto(fOccZ));}
  TH2F *GetOccZNopipe()		{return (TH2F*)(GetHisto(fOccZNopipe));}

  TH2F *GetOccThetaPhi()	{return (TH2F*)(GetHisto(fOccThetaPhi));}
  TH2F *GetOccThetaPhi2()	{return (TH2F*)(GetHisto(fOccThetaPhi2));}
  TH2F *GetOccAThetaPhi()	{return (TH2F*)(GetHisto(fOccAThetaPhi));}
  TH2F *GetOccLThetaPhi()	{return (TH2F*)(GetHisto(fOccLThetaPhi));}
  TH2F *GetNpmtLThetaPhi()	{return (TH2F*)(GetHisto(fNpmtLThetaPhi));}

  TH1F *GetOccRayleigh()	{return (TH1F*)(GetHisto(fOccRayleigh));}
  TH1F *GetOccDirect()		{return (TH1F*)(GetHisto(fOccDirect));}
  TH1F *GetOccReflected()	{return (TH1F*)(GetHisto(fOccReflected));}
  TH1F *GetOccRayleighTotal()	{return (TH1F*)(GetHisto(fOccRayleighTotal));}
  TH1F *GetOccDirectTotal()	{return (TH1F*)(GetHisto(fOccDirectTotal));}
  TH1F *GetOccReflectedTotal()	{return (TH1F*)(GetHisto(fOccReflectedTotal));}
