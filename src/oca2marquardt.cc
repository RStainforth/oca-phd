///////////////////////////////////////////////////////////////////////////////////////
///
/// FILENAME: oca2marquardt.cc
///
/// EXECUTABLE: oca2mardquardt
///
...
int main( int argc, char** argv ){
  ...
  // Check that the 'oca2marquardt' executable has been used properly 
  if ( argc != 2 ){
    cout << "oca2minuit: Error, no path specified for the OCA fit-file.\n";
    cout << "usage: oca2marquardt /path/to/fit-file.ratdb\n";
  }

  cout << "\n";
  cout << "#######################################" << endl;
  cout << "######## OCA2MARQUARDT Start ########" << endl;
  cout << "#######################################" << endl;
  cout << "\n";
