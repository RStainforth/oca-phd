...
///        a specific parameter included in the LOCASOpticsModel
///        object.
///        
///          
...
///         see the LOCASModelParameter::GetNInGroup() description.
///
////////////////////////////////////////////////////////////////////
...
namespace LOCAS{
  ...
  public:
    ...
    // The constructors and destructors for the LOCASModelParameter object.
    LOCASModelParameter(){ }
    LOCASModelParameter( string parameterName, 
