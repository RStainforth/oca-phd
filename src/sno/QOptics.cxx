  ...
  : source(sx,sy,sz), psup_centre(0,0,0), psup_centre_target(0,0,0), av_centre(0,0,0)
{
  ...
  if (!fQOpticsInitialized) { // Load up the acrylic panels' layout from SNOMAN
    ...
    */
    ...
    char* qsnoroot = getenv("QLOCAS_ROOT");

    if( qsnoroot!=NULL ) {
      filenameString2 = 
	new char[strlen(qsnoroot)+1+strlen("/data/ncd_anchors.dat")+1];
    } else {
      printf("QOptics requires that you have the QLOCAS_ROOT environment variable set.\n");
...
{  
  ...
  //std::cout << "Qtarget theta: " << thPMTtarget << std::endl;
  
  Double_t theta = rtsafe(0,M_PI,1e-3);
  //std::cout << "Qtheta: " << theta << std::endl;
  Double_t th1 = theta1(theta);
  //std::cout << "Qtheta1: " << th1 << std::endl;
  Double_t th2 = theta2(theta) + th1;
  //std::cout << "Qtheta2: " << th2 << std::endl;
  ...
  a3.SetMag( p.Mag() );
  //std::cout << "(a3 - p).Mag(): " << (a3-p).Mag() << std::endl;
  ...
  //std::cout << "Target PMT thets is: " << thPMTtarget << std::endl;
  //std::cout << "Fitted theta is: " << theta << std::endl;
  //std::cout << "StartPos Mag is: " << 10.0 * source.Mag() << std::endl;
  //std::cout << "EndPos Mag is: " << 10.0 * p.Mag() << std::endl;
  //std::cout << "D2O RI is: " << nd << std::endl;
  //std::cout << "AV RI is: " << na << std::endl;
  //std::cout << "Water RI is: " << nh << std::endl;
  //std::cout << "Theta1 is: " << th1 << std::endl;
  //std::cout << "Theta2 is: " << th2 << std::endl;
  //std::cout << "Theta3 is: " << th3 << std::endl;
  fDd2o = direction.Mag();
  //std::cout << "Dist in D2O is: " << 10.0 * fDd2o << std::endl;
  fDacrylic = inter.Mag();
  //std::cout << "Dist in AV is: " << 10.0 * fDacrylic << std::endl;
  fDh2o = incident.Mag();
  //std::cout << "Dist in H2O is: " << 10.0 * fDh2o << std::endl;
  //std::cout << "---------------" << std::endl;
...
Bool_t QOptics::getDistancesOutside(TVector3 p,TVector3 n)
{
  ...
  if (thetainit < thcutout) {
    ...
    //std::cout << "Target PMT theta is: " << thPMTtarget << std::endl;
    //std::cout << "Fitted theta is: " << theta << std::endl;
    //std::cout << "StartPos Mag is: " << 10.0 * source.Mag() << std::endl;
    //std::cout << "EndPos Mag is: " << 10.0 * p.Mag() << std::endl;
    //std::cout << "D2O RI is: " << nd << std::endl;
...
Double_t QOptics::thResidual(const Double_t &thet)
{
  ...
  if (fSourceInside) {
    ...
    //std::cout << "sno Theta5 is: " << theta5( thet ) << std::endl;
    //std::cout << "sno Theta4 is: " << theta4( thet ) << std::endl;
    //std::cout << "sno Theta3 is: " << theta3( thet ) << std::endl;
    //std::cout << "sno Theta2 is: " << theta2( thet ) << std::endl;
    //std::cout << "sno Theta1 is: " << theta1( thet ) << std::endl;
    //std::cout << "--------------------" << std::endl;
  }
  return retvalue;
}
...
Double_t QOptics::dthResidualdth(const Double_t &thet)
{
  ...
  if (fSourceInside)
    ...
    //std::cout << "sno DTheta5 is: " << d5dt(thet) << std::endl;
    //std::cout << "sno DTheta4 is: " << d4dt(thet) << std::endl;
    //std::cout << "sno DTheta3 is: " << d3dt(thet) << std::endl;
    //std::cout << "sno DTheta2 is: " << d2dt(thet) << std::endl;
    //std::cout << "sno DTheta1 is: " << d1dt(thet) << std::endl;
    //std::cout << "--------------------" << std::endl; 
...
Double_t QOptics::rtsafe(Double_t x1, Double_t x2, Double_t xacc)
{
  ...
  funcd(x1,&fl,&df);
  //std::cout << "x1 is: " << x1 << " and fl is: " << fl << " and df is: " << df << std::endl;
  funcd(x2,&fh,&df);
  //std::cout << "x2 is: " << x2 << " and fh is: " << fh << " and df is: " << df << std::endl;
  ...
  dx=dxold;
  funcd(rts,&f,&df);
  //std::cout << "1st: rts is: " << rts << " and f is: " << f << " and df is: " << df << std::endl;
  for (j=1;j<=RTSAFE_MAXIT;j++) {
    ...
    funcd(rts,&f,&df);
    //std::cout << "2nd: rts is: " << rts << " and f is: " << f << " and df is: " << df << std::endl;
    if (f < 0.0)
      xl=rts;
    else
      xh=rts;
