...
#
setenv LOCAS_ROOT /home/sno/barros/optics/qoca
...
setenv LD_LIBRARY_PATH "${LD_LIBRARY_PATH}:${LOCAS_ROOT}/lib"
set system=`uname -s`

if ( "$system" == "Darwin" ) then
    setenv DYLD_LIBRARY_PATH "${DYLD_LIBRARY_PATH}:${LOCAS_ROOT}/lib"
endif
setenv PATH "${PATH}:${LOCAS_ROOT}/bin"
